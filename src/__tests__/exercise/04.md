...
A package that helps to generate fake test data like username or password https://www.npmjs.com/package/@faker-js/faker?activeTab=readme 
A package that generates fake yet realistic data for unit tests and mimics an object factory https://www.npmjs.com/package/@jackfranklin/test-data-bot

There are tools available for us in diff packages. This exercise is good because it showed that we have to remove unnecessary implementation details from our tests and care about what we need to care as the output and the behaviour of our forms
